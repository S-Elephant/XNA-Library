...
namespace XNALib
{
    ...
    /// http://xnawiki.com/index.php?title=Generic_Resource_Pool
    /// </summary>
    ...
    public class Pool<T> where T : class
    {
        ...
        /// <summary>
        /// Returns an object at the given index. The index must fall in the range of [0, items.Count].
        /// </summary>
        /// <param name="index">The index of the object to get</param>
        /// <returns>An object found at the index</returns>
        public T this[int index, bool validOnly]
        {
            get
            {
                // Only valid objects, same as calling above method.
                if (validOnly)
                {
                    index += InvalidCount;
