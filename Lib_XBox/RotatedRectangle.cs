...
{
    /// <summary>
    /// Credits/Author: http://www.xnadevelopment.com/tutorials/rotatedrectanglecollisions/rotatedrectanglecollisions.shtml
    /// </summary>
    public class RotatedRectangle
    {
        ...
        public RotatedRectangle(Rectangle theRectangle, float rotationInRad)
        {
        ...
        public void DebugDraw(SpriteBatch spriteBatch, Vector2 offset, Color drawColor)
        {
            int offsetX = offset.Xi();
            int offsetY = offset.Yi();
            spriteBatch.Draw(Common.White1px, new Rectangle(UpperLeftCorner().Xi() - 1 + offsetX, UpperLeftCorner().Yi() - 1 + offsetY, 3, 3), drawColor);
            spriteBatch.Draw(Common.White1px, new Rectangle(UpperRightCorner().Xi() - 1 + offsetX, UpperRightCorner().Yi() - 1 + offsetY, 3, 3), drawColor);
            spriteBatch.Draw(Common.White1px, new Rectangle(LowerLeftCorner().Xi() - 1 + offsetX, LowerLeftCorner().Yi() - 1 + offsetY, 3, 3), drawColor);
            spriteBatch.Draw(Common.White1px, new Rectangle(LowerRightCorner().Xi() - 1 + offsetX, LowerRightCorner().Yi() - 1 + offsetY, 3, 3), drawColor);
        }
    }
}
